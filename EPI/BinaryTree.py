...
printInorder(root) 
  ...
  def buildTree(inOrder, preOrder, inStrt, inEnd, node_to_idx): 
    ...
    # Else find the index of this node in Inorder traversal 
    inIndex = node_to_idx[tNode.data] 
      
    # Using index in Inorder Traversal, construct left  
    # and right subtrees 
    tNode.left = buildTree(inOrder, preOrder, inStrt, inIndex-1,node_to_idx) 
    tNode.right = buildTree(inOrder, preOrder, inIndex + 1, inEnd,node_to_idx) 
